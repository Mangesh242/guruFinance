  ...
  return (
    <Box id="services" sx={{ py: 8, bgcolor: 'background.default' }}>
      <Container maxWidth="lg">
        ...
        >
          We offer a comprehensive range of insurance products to protect you, your family, and your assets.
        </Typography>
            ...
            <Grid xs={12} sm={6} md={4} key={index}>
              ...
              >
                ...
                <CardActions sx={{ justifyContent: 'center', pb: 3 }}>
                  <Button size="medium" variant="outlined" onClick={scrollToContact}>
                    Get Quote
                  </Button>
                </CardActions>
              </Card>
