      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          <Grid xs={12} sm={6} md={3}>
            ...
            <Typography variant="body2" sx={{ mb: 2, color: 'grey.400' }}>
              Your trusted partner for comprehensive insurance solutions. Protecting what matters most since 2003.
            </Typography>
            <Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 3 }}>
            <Link href="#" variant="body2" sx={{ color: 'grey.400', '&:hover': { color: 'white' } }}>
              Privacy Policy
            </Link>
            <Link href="#" variant="body2" sx={{ color: 'grey.400', '&:hover': { color: 'white' } }}>
              Terms of Service
